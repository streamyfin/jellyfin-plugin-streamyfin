...
public class PluginDatabase
{
    ...
    public void RemoveDeviceToken(Guid deviceId)
    {
        ...
        context.DeviceTokens.Where(t => t.DeviceId == deviceId).ExecuteDelete();
    }
    ...
    public int RemoveDeviceTokensNamed(IEnumerable<string> tokens)
    {
        ...
        // One statement. Two sends told about the same dead tokens at once each loaded the
        // rows and then deleted them, and the second delete failed its concurrency check.
        // A delete that finds the rows gone counts nothing and carries on.
        return context.DeviceTokens.Where(t => dead.Contains(t.Token)).ExecuteDelete();
    }
